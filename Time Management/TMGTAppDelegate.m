...
#import "TMGTAppDelegate.h"
#include "TMGTEventItemListTableViewController.h"

@implementation TMGTAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    TMGTEventItemListTableViewController *controller = (TMGTEventItemListTableViewController *)navigationController.topViewController;
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Time_Management.sqlite"];
